...
<div class="max-w-2xl mx-auto animate-fade-in-up">
    <div class="flex items-center mb-6 space-x-4">
        ...
        <h1 class="text-3xl font-extrabold text-solarized-base01">Edit Paket Pengadaan</h1>
    </div>

    <div class="solar-card rounded overflow-hidden">
        <div class="px-6 py-8 sm:p-10">
            <form id="formEditPaket" action="{{ route('paket-pengadaan.update', $paket->paket_id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        <label for="nama_paket" class="block text-base font-semibold text-solarized-base00 mb-1">Nama Paket</label>
                        <input type="text" name="nama_paket" id="nama_paket" required value="{{ old('nama_paket', $paket->nama_paket) }}"
                            class="block w-full px-4 py-3 bg-solarized-base3 border @error('nama_paket') border-solarized-red @else border-solarized-base1 @enderror rounded focus:ring-2 focus:ring-solarized-blue focus:border-solarized-blue transition-all outline-none text-solarized-base00 text-lg">
                        @error('nama_paket')
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="metode_pengadaan" id="metode_pengadaan" 
                            ...
                            <option value="E-Purchasing" {{ old('metode_pengadaan', $paket->metode_pengadaan) == 'E-Purchasing' ? 'selected' : '' }}>E-Purchasing</option>
                            <option value="Tender Cepat" {{ old('metode_pengadaan', $paket->metode_pengadaan) == 'Tender Cepat' ? 'selected' : '' }}>Tender Cepat</option>
                            <option value="Tender" {{ old('metode_pengadaan', $paket->metode_pengadaan) == 'Tender' ? 'selected' : '' }}>Tender</option>
                            <option value="Penunjukan Langsung" {{ old('metode_pengadaan', $paket->metode_pengadaan) == 'Penunjukan Langsung' ? 'selected' : '' }}>Penunjukan Langsung</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="opd_pemilik" id="opd_pemilik" value="{{ old('opd_pemilik', $paket->opd_pemilik) }}"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="pagu_anggaran" id="pagu_anggaran" value="{{ old('pagu_anggaran', $paket->pagu_anggaran) }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="waktu_pelaksanaan" id="waktu_pelaksanaan" value="{{ old('waktu_pelaksanaan', $paket->waktu_pelaksanaan) }}"
...
<script>
    document.getElementById('formEditPaket').addEventListener('submit', function(e) {
        e.preventDefault();
