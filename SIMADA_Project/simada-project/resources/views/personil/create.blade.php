...
<div class="max-w-2xl mx-auto animate-fade-in-up">
    <div class="flex items-center mb-6 space-x-4">
        ...
        <h1 class="text-3xl font-extrabold text-solarized-base01">Tambah Personil Baru</h1>
    </div>
                ...
                <div class="grid grid-cols-1 gap-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="detail_skp" id="detail_skp" rows="4"
                            class="block w-full px-4 py-3 bg-solarized-base3 border @error('detail_skp') border-solarized-red @else border-solarized-base1 @enderror rounded focus:ring-2 focus:ring-solarized-blue focus:border-solarized-blue transition-all outline-none text-solarized-base00 text-lg">{{ old('detail_skp') }}</textarea>
                        @error('detail_skp')
                            <p class="mt-2 text-sm text-solarized-red font-medium">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="skp_limit" id="skp_limit" value="{{ old('skp_limit', 5) }}" min="1"
